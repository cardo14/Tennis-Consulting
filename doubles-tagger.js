...
function loveAll() {
 ...
 // Rally length
 sheet.getRange('K' + (lastRow + 1)).setValue("1");
 // Set isPointStart to be true
 sheet.getRange('E' + (lastRow + 1)).setValue("1");
 //Set side
 sheet.getRange('L' + (lastRow + 1)).setValue("Deuce");
 //changeServerName();
...
function loveFifteen() {
 ...
 // Set isPointStart to be true
 sheet.getRange('E' + (lastRow + 1)).setValue("1");
 sheet.getRange('L' + (lastRow + 1)).setValue("Ad");
 updateGameScore();
...
function serveZoneT() {
  ...
  sheet.getRange('O' + (lastRow)).setValue('T');
}
...
function serveZoneWide() {
  ...
  // Set values in the first empty row for columns A, B, and C to zero
 sheet.getRange('O' + (lastRow)).setValue('Wide');
}
...
function serveZoneBody() {
  ...
  // Set values in the first empty row for columns A, B, and C to zero
  sheet.getRange('O' + (lastRow)).setValue('Body');
}
...
function secondServeZoneT() {
  ...
  // Set values in the first empty row for columns A, B, and C to zero
  sheet.getRange('S' + (lastRow)).setValue('T');
}
...
function secondServeZoneWide() {
  ...
  // Set values in the first empty row for columns A, B, and C to zero
 sheet.getRange('S' + (lastRow)).setValue('Wide');
}
...
function secondServeZoneBody() {
  ...
  // Set values in the first empty row for columns A, B, and C to zero
  sheet.getRange('S' + (lastRow)).setValue('Body');
}
...
function firstServeIn() {
  ...
  // Set values in the first empty row for columns A, B, and C to zero
  sheet.getRange('N' + (lastRow)).setValue('1');
}
...
function firstServeOut() {
  ...
  // Set values in the first empty row for columns A, B, and C to zero
  sheet.getRange('N' + (lastRow)).setValue('0');
}
...
function secondServeIn() {
  ...
  // Set values in the first empty row for columns A, B, and C to zero
  sheet.getRange('R' + (lastRow)).setValue('1');
}
...
function secondServeOut() {
  ...
  // Set values in the first empty row for columns A, B, and C to zero
  sheet.getRange('R' + (lastRow)).setValue('0');
...
function serveFormationNormal() {
  ...
  // Set values in the first empty row for columns A, B, and C to zero
  sheet.getRange('AO' + (lastRow)).setValue('Normal');
}

function serveFormationOther() {
  var sheet = SpreadsheetApp.getActiveSpreadsheet().getActiveSheet();
  var columnToCheck = 1; // Change this to the column number you are interested in
  ...
  // Set values in the first empty row for columns A, B, and C to zero
 sheet.getRange('AO' + (lastRow)).setValue('Other');
}

function serveFormationI() {
  var sheet = SpreadsheetApp.getActiveSpreadsheet().getActiveSheet();
  var columnToCheck = 1; // Change this to the column number you are interested in
  ...
  // Set values in the first empty row for columns A, B, and C to zero
  sheet.getRange('AO' + (lastRow)).setValue('I');
}


function returnFormationNormal() {
  var sheet = SpreadsheetApp.getActiveSpreadsheet().getActiveSheet();
  var columnToCheck = 1; // Change this to the column number you are interested in
  ...
  // Set values in the first empty row for columns A, B, and C to zero
 sheet.getRange('AP' + (lastRow)).setValue('Normal');
}

function returnFormation2Back() {
  var sheet = SpreadsheetApp.getActiveSpreadsheet().getActiveSheet();
  var columnToCheck = 1; // Change this to the column number you are interested in
  ...
  // Set values in the first empty row for columns A, B, and C to zero
  sheet.getRange('AP' + (lastRow)).setValue('2-Back');
}
...
function forehandCrossDeuce() {
  ...
  // Set values in the first empty row for columns A, B, and C to zero
  sheet.getRange('AD' + (maxLastRow + 1)).setValue('Forehand');
  sheet.getRange('AC' + (maxLastRow + 1)).setValue('Crosscourt');
  sheet.getRange('K' + (maxLastRow + 1)).setValue(sheet.getRange('K' + maxLastRow).getValue() + 1);
  sheet.getRange('L' + (maxLastRow + 1)).setValue('Deuce');
}
...
function forehandCrossAd() {
  ...
  sheet.getRange('AC' + (maxLastRow + 1)).setValue('Crosscourt');
  sheet.getRange('K' + (maxLastRow + 1)).setValue(sheet.getRange('K' + maxLastRow).getValue() + 1);
  sheet.getRange('L' + (maxLastRow + 1)).setValue('Ad');
...
function backhandCrossDeuce() {
 var sheet = SpreadsheetApp.getActiveSpreadsheet().getActiveSheet();
  ...
  // Set values in the first empty row for columns A, B, and C to zero
  sheet.getRange('AD' + (maxLastRow + 1)).setValue('Backhand');
  sheet.getRange('AC' + (maxLastRow + 1)).setValue('Crosscourt');
  sheet.getRange('K' + (maxLastRow + 1)).setValue(sheet.getRange('K' + maxLastRow).getValue() + 1);
  sheet.getRange('L' + (maxLastRow + 1)).setValue('Deuce');
...
function forehandDTLDeuce() {
 var sheet = SpreadsheetApp.getActiveSpreadsheet().getActiveSheet();
  ...
  // Set values in the first empty row for columns A, B, and C to zero
  sheet.getRange('AD' + (maxLastRow + 1)).setValue('Forehand');
  sheet.getRange('AC' + (maxLastRow + 1)).setValue('Down the Line');
  sheet.getRange('K' + (maxLastRow + 1)).setValue(sheet.getRange('K' + maxLastRow).getValue() + 1);
  sheet.getRange('L' + (maxLastRow + 1)).setValue('Deuce');
...
var columnsToCheck = [11]; // Change this to the column number you are interested in
  ...
  // Set values in the first empty row for columns A, B, and C to zero
  sheet.getRange('L' + (maxLastRow)).setValue('Deuce');
}
...
var columnsToCheck = [11]; // Change this to the column number you are interested in
  ...
  // Set values in the first empty row for columns A, B, and C to zero
  sheet.getRange('L' + (maxLastRow)).setValue('Ad');
}
...
function errorWideRight() {
  ...
  sheet.getRange('AT' + (maxLastRow)).setValue('1');
  copyPointScore();
  copyGameScore();
  copyTiebreakScore();
//  whoWonPoint('error');
...
function errorWideLeft() {
  ...
  sheet.getRange('G' + (maxLastRow)).setValue('1');
  sheet.getRange('AU' + (maxLastRow)).setValue('1');
  copyPointScore();
  copyGameScore();
  copyTiebreakScore();
 // whoWonPoint('error');
...
function errorNet() {
  ...
  sheet.getRange('G' + (maxLastRow)).setValue('1');
  sheet.getRange('AV' + (maxLastRow)).setValue('1');
  copyPointScore();
  copyGameScore();
  copyTiebreakScore();
 // whoWonPoint('error');
...
function errorLong() {
  ...
  sheet.getRange('G' + (maxLastRow)).setValue('1');
  sheet.getRange('AW' + (maxLastRow)).setValue('1');
  copyPointScore();
  copyGameScore();
  copyTiebreakScore();
 // whoWonPoint('error');
...
function winner() {
  ...
  // Set values in the first empty row for columns A, B, and C to zero
  sheet.getRange('G' + (maxLastRow)).setValue('1');
  sheet.getRange('AS' + (maxLastRow)).setValue('1');
  copyPointScore();
  copyGameScore();
  copyTiebreakScore();
  // Check for Ace
  if ((sheet.getRange('K' + (maxLastRow)).getValue() == '1') && (sheet.getRange('AO' + (maxLastRow)).getValue() == '1')) {
      sheet.getRange('V' + (maxLastRow)).setValue('1');
  }
  //whoWonPoint("winner");
}
...
function lob()
{
  ...
  // Set values in the first empty row for columns A, B, and C to zero
  sheet.getRange('AX' + (maxLastRow)).setValue('1');
...
function shotHitByA1()
{
  var sheet = SpreadsheetApp.getActiveSpreadsheet().getActiveSheet();
  var teamAplayer1 = sheet.getRange('BG2').getValue();
  var columnsToCheck = [11]
  var maxLastRow = 0;
  ...
  sheet.getRange('AY' + (maxLastRow)).setValue(teamAplayer1);

}

function shotHitByA2()
{
  var sheet = SpreadsheetApp.getActiveSpreadsheet().getActiveSheet();
  var teamAplayer2 = sheet.getRange('BH2').getValue();
  var columnsToCheck = [11]
  var maxLastRow = 0;
  ...
  sheet.getRange('AY' + (maxLastRow)).setValue(teamAplayer2);
}

function shotHitByB1()
{
  var sheet = SpreadsheetApp.getActiveSpreadsheet().getActiveSheet();
  var teamBplayer1 = sheet.getRange('BJ2').getValue();
  var columnsToCheck = [11]
  var maxLastRow = 0;
  ...
  sheet.getRange('AY' + (maxLastRow)).setValue(teamBplayer1);
}

function shotHitByB2()
{
  var sheet = SpreadsheetApp.getActiveSpreadsheet().getActiveSheet();
  var teamBplayer2 = sheet.getRange('BK2').getValue();
  var columnsToCheck = [11]
  var maxLastRow = 0;
  ...
  sheet.getRange('AY' + (maxLastRow)).setValue(teamBplayer2);
...
function isFakeA()
{
  ...
  // Set values in the first empty row for columns A, B, and C to zero
  sheet.getRange('AM' + (maxLastRow)).setValue('1');
...
function bothAtNetB()
{
  ...
  // Set values in the first empty row for columns A, B, and C to zero
  sheet.getRange('AL' + (maxLastRow)).setValue('1');
